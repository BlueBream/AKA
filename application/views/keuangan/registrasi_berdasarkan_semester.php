	...
	<div class="row-fluid">
		<div class="control-group">		
				<div class="controls">
					...
					<label class="control-label" for="form-field-1">Cari Data Pembayaran Berdasarkan Semester <?php echo $this->input->post('src'); ?> dan Tahun <?php echo $this->input->post('src-t'); ?></label>
				</div>				
		</div>
	</div><!--/.row-fluid-->
	<br>
					...
					<tr>
						...
						<td  style="text-align:center;" class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
								...
								<a onClick="return confirm('Anda yakin ingin menghapus data ini ?')" class="red" href="<?php echo base_url(); ?>c_index_aka/hapus_registrasi_berdasarkan_semester/<?php echo $data['id_registrasi']; ?>">
