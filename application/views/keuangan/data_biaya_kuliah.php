	...
	<div class="row-fluid">
		...
		<div class="widget-body">
					<div class="widget-main">
						<form class="form-horizontal" method='POST' action='<?php echo base_url(); ?>c_index_aka/prosesinput_data_biaya_kuliah' enctype='multipart/form-data' />
					...
					<tr>
						...
						<td class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
								...
								<a class="green" href="<?php echo base_url(); ?>c_index_aka/edit_data_biaya_kuliah/<?php echo $data['id']; ?>">
