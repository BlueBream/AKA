				...
				<thead>
					<tr>
						...
						<th>
							...
							<a class="green" href="<?php echo base_url(); ?>p_jurusan/input_jadwal_kuliah">
					...
					<tr>
						...
						<td class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
								...
								<a onClick="return confirm('Anda yakin ingin menghapus data ini ?')" class="red" href="<?php echo base_url(); ?>p_jurusan/hapus_jadwal_kuliah/<?php echo $data['id']; ?>/<?php echo $data['path']; ?>">
