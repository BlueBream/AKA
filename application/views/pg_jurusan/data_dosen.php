				...
				<thead>
					<tr>
						...
						<th style="text-align:center;">
							<a class="green" href="<?php echo base_url(); ?>p_jurusan/input_data_dosen">
					...
					<tr>
						...
						<td  style="text-align:center;" class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
								...
								<a onClick="return confirm('Anda yakin ingin menghapus data ini ?')" class="red" href="<?php echo base_url(); ?>p_jurusan/hapus_dosen/<?php echo $data['id_dosen']; ?>/<?php echo $data['foto']; ?>">
									<i class="icon-trash bigger-130"></i>
								</a>
								<br>
								<a class="blue" href="<?php echo base_url(); ?>p_jurusan/detail_matkul_dosen/<?php echo $data['id_dosen']; ?>">
									<i class="icon-zoom-in bigger-130"></i> Input Mata Kuliah
								</a>
								<br>
								<a class="blue" href="<?php echo base_url(); ?>p_jurusan/data_matkul_dosen/<?php echo $data['id_dosen']; ?>">
