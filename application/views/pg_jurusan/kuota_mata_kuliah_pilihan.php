...
<div class="row-fluid">
			...
			<div class="table-header">
				Results for "hasil pencarian Data Matakuliah" <a href='<?php echo base_url();?>p_jurusan/Kuota_mata_kuliah_pilihan'><button class="btn btn-small btn-success">
															lihat Semua
				...
				<thead>
					<tr>
						...
						<th>
							...
							<a class="green" href="<?php echo base_url(); ?>p_jurusan/t_kuota_mata_kuliah_pilihan">
				...
				?>
						<td class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
								<a class="green" href="<?php echo base_url(); ?>p_jurusan/l_edit_kuota_matkul_pilihan/<?php echo $data['kode_mk']; ?>">
									<i class="icon-pencil bigger-130"></i>
								</a>
								<a onClick="return confirm('Anda yakin ingin menghapus data ini ?')" class="red" href="<?php echo base_url(); ?>p_jurusan/hapus_kuota_matkul_pilihan/<?php echo $data['kode_mk']; ?>">
