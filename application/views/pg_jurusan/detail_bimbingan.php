...
<div class="row-fluid">
			...
			<table id="sample-table-2" class="table table-striped table-bordered table-hover">
				<thead>
					...
					?>
						<a href="<?php echo base_url();?>p_jurusan/get_mhs_mahasiswa/<?php echo $id_dosen;?>">
					...
					<tr>
						...
						<td  style="text-align:center;" class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
										<a href="<?php echo base_url();?>p_jurusan/delete_mhs_bimbingan/<?php echo $data['id_bimbingan'];?>/<?php echo $data['id_dosen'];?>">
