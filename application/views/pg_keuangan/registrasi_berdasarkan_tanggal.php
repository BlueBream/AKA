	...
	<div class="row-fluid">
		<div class="control-group">		
				<div class="controls">
					...
					<label class="control-label" for="form-field-1">Data hasil pencarian registrasi dari tanggal <?php echo $this->input->post('date1'); ?> dan tanggal <?php echo $this->input->post('date2'); ?></label>
				</div>				
		</div>
	</div><!--/.row-fluid-->
	<br>
					...
					<tr>
						...
						<td  style="text-align:center;" class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
								...
								<a onClick="return confirm('Anda yakin ingin menghapus data ini ?')" class="red" href="<?php echo base_url(); ?>p_keuangan/hapus_registrasi_berdasarkan_tanggal/<?php echo $data['id_registrasi']; ?>">
