<script type="text/javascript">
	function tot_bayar(){
		...
		if(tb1 > tb2){
			...
			document.forms.reg.kembalian.value="0";
		}
		if(tb1 < tb2){
			document.forms.reg.kembalian.value=tb2-tb1;
			document.forms.reg.sisa_cicilan.value="0";
		}
	}
	function tot_sks(){
		// total biaya
...
<div class="page-header position-relative">
	...
	<div class="row-fluid">
		<div class="widget-box">
			...
			<div class="widget-body">
						<div class="widget-main">
							<form class="form-horizontal" method='POST' action='<?php echo base_url(); ?>p_keuangan/prosesinput_registrasi' name="reg" enctype='multipart/form-data' />
								<div class="control-group">
