			...
			<table id="sample-table-2" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th>Semester yang Sudah Bayar</th>
						<th>Tambah Registrasi
						</th>
					</tr>
				</thead>
					...
					<tr>
						...
						<td class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
								<a class="green" href="<?php echo base_url(); ?>p_keuangan/input_registrasi/<?php echo $row->id_mahasiswa; ?>">
									<i class="icon-plus bigger-130"></i> Input Registrasi
								</a>
							</div>
						</td>						
