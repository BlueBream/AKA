		...
		<div class="control-group">		
				<div class="controls">
					...
					<form method="post">
						...
						<select name="src">
							<option name="src">1</option>
							<option name="src">2</option>
							<option name="src">3</option>
							<option name="src">4</option>
							<option name="src">5</option>
							<option name="src">6</option>
							<option name="src">7</option>
							<option name="src">8</option>
							<option name="src">9</option>
							<option name="src">10</option>
						</select> 
						Tahun
						<select name="src-t">
							<?php 
					...
					<label class="control-label" for="form-field-1">Cari Data Pembayaran Berdsarkan Semester <?php echo $this->input->post('src'); ?> dan Tahun <?php echo $this->input->post('src-t'); ?></label>
				</div>				
		</div>
	</div><!--/.row-fluid-->
	<br>
					...
					<tr>
						...
						<td  style="text-align:center;" class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
								...
								<!--<a class="green" href="<?php echo base_url(); ?>p_keuangan/edit_data_dosen/<?php echo $data['id_dosen']; ?>">
									<i class="icon-pencil bigger-130"></i>
								</a><br>-->

								<a onClick="return confirm('Anda yakin ingin menghapus data ini ?')" class="red" href="<?php echo base_url(); ?>p_keuangan/hapus_registrasi_berdasarkan_semester/<?php echo $data['id_registrasi']; ?>">
