	...
	<div class="row-fluid">
		...
		<div class="control-group">		
				<div class="controls">
					...
					<form method = "Post" action="<?php echo base_url(); ?>p_mahasiswa/pengumuman_akademik">
					<input type="text" id="form-field-1" placeholder="Nama Bahan Ajar" name="nama"/>
					<br>
					<input type="submit" class="btn btn-small btn-primary" value="Search" name="cari">
					</form>
				</div>
		</div>
	</div><!--/.row-fluid-->
