...
<body>
<form action ="<?php echo base_url();?>c_index_aka/login_dosen" method="post">
    <div class="form">
		<div class="header"><i class="icon-unlock"></i> LOGIN DOSEN<br></div>
		<div class="f_input">
			<center>
			<input type="text" name="username" class="in" placeholder="username" required>			
			<input type="password" name="password_simak" class="in" placeholder="password" required>
			</center>
		</div>
		<div class="f_button">
			<center>				
