...
<div class="row-fluid">
	<h2>Form Ganti Password Dosen</h2>
	...
	<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						...
						<form class="form-horizontal" method='POST' id="loginForm" action='<?php echo base_url(); ?>c_index_aka/prosesedit_password_dosen' enctype='multipart/form-data' />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="password" name="password_simak" id="pass2" onkeyup="checkPass(); return false;" placeholder="" />
