...
<li class="active">Edit Data Staff Keuangan</li>
</ul><!--.breadcrumb-->
...
<div class="row-fluid">
	<h2>Form Ganti Password Staff Keuangan</h2>
	
	<div class="widget-box">
				<div class="widget-header">
					<h4 class="smaller">
						Ganti Password Staff Keuangan
					</h4>
				</div>
				...
				<div class="widget-body">
					<div class="widget-main">
						...
						<form class="form-horizontal" method='POST' id="loginForm" action='<?php echo base_url(); ?>c_index_aka/prosesedit_password_keuangan' enctype='multipart/form-data' />
