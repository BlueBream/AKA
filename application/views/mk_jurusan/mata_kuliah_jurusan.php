					...
					<tr>
							...
							<td>
								<?php if($mk['pengisian_nilai'] == "dibuka"){ ?>
									<a href="<?php echo base_url(); ?>c_index_aka/proses_buka_mk/<?php echo $mk['id_mk']; ?>"><button class="btn btn-small btn-success">Dibuka</button></a>
								<?php }else{ ?>
									<a href="<?php echo base_url(); ?>c_index_aka/proses_buka_mk/<?php echo $mk['id_mk']; ?>"><button class="btn btn-small btn-danger">Ditutup</button></a>
								<?php } ?>
							</td>
