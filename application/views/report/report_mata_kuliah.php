...
<table width="100%">
	<tr>
		<td align="center">
			<b >Data Mata Kuliah Akademi Kimia Analisis
			</b>
		</td>
	</tr>
</table>
...
<table class="gridtable" cellpadding="5">
	<tr class="abu-abu">
		...
		<td style="text-align:center;font-weight:bold;">Kode Mata Kuliah</td>
		<td style="text-align:center;font-weight:bold;">Nama Mata Kuliah</td>
		<td style="text-align:center;font-weight:bold;">Jumlah SKS</td>
		<td style="text-align:center;font-weight:bold;">Semester</td>
		<td style="text-align:center;font-weight:bold;">Status</td>
		<td style="text-align:center;font-weight:bold;">Praktikum</td>
	...
	<tr>
		...
		<td style="text-align:center;"><?php echo $data['kode_mk']; ?></td>
		<td style="text-align:left;"><?php echo $data['nama_mk']; ?></td>
		<td style="text-align:center;"><?php echo $data['jumlah_sks']; ?></td>
