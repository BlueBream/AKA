...
<table border="0" width="100%">
	<tr>
		<td width="8%" ><img src="assets/images/Kemenperin.jpg" width="150px"></td>
		<td align="center">
		...
		<td width="15%" style="text-align:right" class="title_alamat">FR/BAAK-1.6.0.1<br><img class="geser" src="assets/images/LOGO.jpg" width="70px" height="70px"></td>
	</tr>
	<tr>
		<td colspan="3">
			<hr>
...
<table border="0" width="100%">
		...
		<td colspan="5" align="center">
			...
			<font class="title_h3">
				<?php 
					...
					echo "Nomor : ".$ambil_nomor['no_transkrip'];
				 ?>
			</font>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="title_ket">: <?php
			$tanggal_lama =  $ambil_data_2['ttl'];
			$tanggal_ex = explode("/", $tanggal_lama);
			$tanggal_ex_2 = explode(" ", $tanggal_ex[0]);
			$bulan = $tanggal_ex[1];
			if($bulan == "1"){
				$bulan = "Januari";
			}else if($bulan == "2"){
			...
			echo $tanggal_ex_2[0].", ".$tanggal_ex_2[1]." ".$bulan." ".$tanggal_ex[2]; 
		?></td>
	</tr>
	<tr>
...
<table class="gridtable" cellpadding="7">
	<tr class="abu-abu">
		...
		<td style="width:50px;"align="center" class="title_name">SKS</td>
		<td style="width:50px;"align="center" class="title_name">Huruf Mutu</td>
		<td style="width:50px;"align="center" class="title_name">Angka Mutu</td>
		<td style="width:50px;"align="center" class="title_name">Nilai Mutu</td>
	</tr>
	<tr>
