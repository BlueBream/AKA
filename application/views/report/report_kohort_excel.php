...
header("Content-Disposition: attachment; filename = report_kohort.xls");
...
<table class="gridtable" cellpadding="5">
	<tr>
		...
		<td style="text-align:center;font-weight:bold;">Nama orang tua; Pendidikan orang tua; Pekerjaan orang tua; Alamat orang tua; Nomor Telepon Mahasiswa</td>
	</tr>
	<?php 
		$no = 1;
