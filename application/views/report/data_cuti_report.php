...
<div class="page-header position-relative">
	...
	<div class="row-fluid">
		<form method="post" action='<?php echo base_url();?>c_index_aka/report_data_cuti'>
		...
		<div class="controls">
			...
			<div class="controls">
				<input type="submit" name="cari_cuti" class="btn btn-info btn-small" value="Buat Laporan">
			</div>					
		</div>
		</form>
	</div><!--/.row-fluid-->
