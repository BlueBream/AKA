	...
	<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						...
						<form class="form-horizontal" method='POST' action='<?php echo base_url(); ?>p_dosen/prosesinput_bahan_kuliah' enctype='multipart/form-data' />
					
							<?php
								$uri3 = $this->uri->segment(3);
								$q = $this->db->query("SELECT * FROM t_mk WHERE id_mk='$uri3'")->row();
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<input type='hidden' value='<?php echo $q->id_mk;?>' name='id_mk'>
									<input type='text' value='<?php echo $q->nama_mk;?>' name='nama' disabled>
								</div>
							</div>
