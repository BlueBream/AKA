	...
	<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						<form class="form-horizontal" method='POST' action='<?php echo base_url(); ?>c_index_aka/p_t_kuota_matkul_pilihan'/>
							<?php 
								foreach($data as $row){
							?>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="form-field-1" name="jumlah_mk" placeholder="Jumlah Kelas" value="<?php echo $row->jumlah_mk;?>"/>
								</div>
							</div>							
							<div class="control-group">
								<label class="control-label" for="form-field-1">Kuota</label>
								<div class="controls">
									<input type="text" id="form-field-1" name="kuota" placeholder="Kuota" value="<?php echo $row->kuota;?>" />
								</div>
							</div>	
							<div class="control-group">
