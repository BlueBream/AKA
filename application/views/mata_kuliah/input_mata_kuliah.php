	...
	<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						...
						<form class="form-horizontal" method='POST' action='<?php echo base_url(); ?>c_index_aka/prosesinput_mata_kuliah' enctype='multipart/form-data' />
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<option value="tidakada">Tidak Ada</option>
										...
										?>
											<option value="<?php echo $mata_kuliah['kode_mk']; ?>"><?php echo $mata_kuliah['nama_mk']; ?></option>
										<?php		
											}
										 ?>
									</select>
