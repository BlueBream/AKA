			...
			?>
				...
				<?php
					if($num_cek < 1){
						...
						?>
						<td><a href='<?php echo base_url();?>c_index_aka/isi_t_kuota_matkul_pilihan/<?php echo $data['kode_mk']; ?>/'><button class='btn btn-small btn-primary'>Isi Kuota</button></a></td>
						<?php
					}else{
						echo "<td><span class='label label-important arrowed'>Penuh</span></td>";
						?>
						<td><a href='<?php echo base_url();?>c_index_aka/isi_t_kuota_matkul_pilihan/<?php echo $data['kode_mk']; ?>/'><button class='btn btn-small btn-danger' disabled>Isi Kuota</button></a></td>
						<?php
					}
				?>
					</tr>
