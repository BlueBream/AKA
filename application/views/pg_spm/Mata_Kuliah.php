	...
	<div class="row-fluid">
		...
		<div class="widget-body">
					<div class="widget-main">
						<form class="form-horizontal" method='POST' action='<?php echo base_url(); ?>p_spm/prosesinput_Kuesioner_MK' enctype='multipart/form-data' />
						...
						<td><?php echo $data['judul'];?></td>
							...
							<td class="td-actions">
								<div class="hidden-phone visible-desktop action-buttons">
									...
									<a onClick="return confirm('Anda yakin ingin menghapus data ini ?')" class="red" href="<?php echo base_url(); ?>p_spm/Hapus_Judul_Kuesioner_MK/<?php echo $data['id_judul']; ?>">
