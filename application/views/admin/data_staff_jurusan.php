...
<ul class="breadcrumb">
	...
	<li class="active">Data Staff Jurusan</li>
</ul><!--.breadcrumb-->
...
<div class="page-header position-relative">
	...
	<div class="row-fluid">
		<div class="control-group">		
				<div class="controls">
					<label class="control-label" for="form-field-1">Cari Data Staff Jurusan</label>
					<form method="post">
...
<div class="row-fluid">
			...
			<div class="table-header">
				Results for Data Staff Jurusan
			</div>			
				...
				<thead>
					<tr>
						...
						<th style="text-align:center;">
							<a class="green" href="<?php echo base_url(); ?>c_index_aka/input_data_staff_Jurusan">
					...
					<tr>
						...
						<td  style="text-align:center;" class="td-actions">
							<div class="hidden-phone visible-desktop action-buttons">
								...
								<a class="green" href="<?php echo base_url(); ?>c_index_aka/edit_data_staff_Jurusan/<?php echo $data['id_user']; ?>">
									<i class="icon-pencil bigger-130"></i>
								</a><br>

								<a onClick="return confirm('Anda yakin ingin menghapus data ini ?')" class="red" href="<?php echo base_url(); ?>c_index_aka/hapus_data_staff_Jurusan/<?php echo $data['id_user']; ?>/<?php echo $data['foto']; ?>">
