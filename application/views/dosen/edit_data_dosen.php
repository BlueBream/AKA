	...
	<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						...
						<form class="form-horizontal" method='POST' action='<?php echo base_url(); ?>c_index_aka/prosesedit_data_dosen' enctype='multipart/form-data' />
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<input type="hidden" id="form-field-1" display="hidden" name="id_dosen" placeholder="id dosen" value="<?php echo $data['id_dosen'];?>" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="form-field-1" name="nama" placeholder="Nama Dosen" value="<?php echo $data['nama'];?>" />
								</div>
							</div>
							...
							<hr>
							<div class="control-group">
								<label class="control-label" for="form-field-1">no_telp</label>
								<div class="controls">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="form-field-1" name="tempat_lahir" placeholder="Tempat Tanggal Lahir" value="<?php echo $data['ttl']; ?>"/>
								</div>
							</div>
