	...
	<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						...
						<?php echo form_open_multipart('c_index_aka/prosesinput_data_dosen');?>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="form-field-1" name="nama" placeholder="Nama dosen" />
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="form-field-1" name="no_telp" placeholder="Kode Pos" />
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="form-field-1" required name="username" placeholder="username" />
								</div>
							</div>

							<div class="control-group">
								<label class="control-label" for="form-field-1">Password Simak </label>

								<div class="controls">
									<input type="password" required id="form-field-1" name="password_simak" placeholder="password simak" />
								</div>
							</div>

							<div class="control-group">
								<label class="control-label" for="form-field-1">Password SMS </label>

								<div class="controls">
									<input type="password" id="form-field-1" name="password_sms" placeholder="password sms" />
								</div>	
							</div>
